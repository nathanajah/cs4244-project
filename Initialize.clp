(defrule initialize-modules
    ...
    (assert (TIMETABLE_SLOT (module-code CS2103T) (timings mon-2 mon-3)))
    (assert (TIMETABLE_SLOT (module-code CS2101) (timings tues-2 tues-3)))
    (assert (TIMETABLE_SLOT (module-code CS3201) (timings wed-2 wed-3)))
    (assert (TIMETABLE_SLOT (module-code CS3202) (timings thurs-2 thurs-3))))
